...
const translationsEn = {
  ...
  'pipeline.dragHint': 'Drag leads between columns or use the dropdown on each card.',
...
const translationsEs: Record<TranslationKey, string> = {
  ...
  'pipeline.dragHint': 'Arrastra leads entre columnas o usa el desplegable en cada tarjeta.',
